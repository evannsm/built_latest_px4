...
/**
 * Output Protocol Configuration for PWM Capture 1
 *
 * Select which Output Protocol to use for outputs PWM Capture 1.
 * 
 * Custom PWM rates can be used by directly setting any value >0.
 * 
 *
 ...
 * @reboot_required True
 */
PARAM_DEFINE_INT32(PWM_AUX_TIM3, 400);
 ...
 * @value 2064 PPS Input
 */
PARAM_DEFINE_INT32(PWM_AUX_FUNC9, 0);
 ...
 * @max 2200
 */
PARAM_DEFINE_INT32(PWM_AUX_DIS9, 900);
 ...
 * @max 1400
 */
PARAM_DEFINE_INT32(PWM_AUX_MIN9, 1000);
 ...
 * @max 2200
 */
PARAM_DEFINE_INT32(PWM_AUX_MAX9, 2000);
 ...
 * @max 2200
 */
PARAM_DEFINE_INT32(PWM_AUX_FAIL9, -1);
